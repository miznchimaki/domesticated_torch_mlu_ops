...
def tmo_fused_recurrent_gated_delta_rule_fwd_kernel(
    ...
    if USE_INITIAL_STATE:
        ...
        # tl.device_print("pointer type: ", p_h0)
        # p_h0 = tl.make_block_ptr(h0 + i_nh * K * V, (K, V), (V,1), (0, 0), (K,V), (1, 0))
...
def fused_recurrent_gated_delta_rule_fwd(
    ...
    final_state = q.new_empty(N, HV, K, V, dtype=torch.float32, device='mlu') if output_final_state else None
